...
@Mod.EventBusSubscriber(modid = SparkTaP.MOD_ID, bus = Mod.EventBusSubscriber.Bus.MOD)
public class DataGenerators {
    ...
    public static void gatherData(GatherDataEvent event){
        ...
        generator.addProvider(event.includeServer(), ModLootTableProdiver.create(packOutput));
